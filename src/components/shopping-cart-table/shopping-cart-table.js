            ...
            <div className="shop-card">
                ...
                <div className="count-items">
                    <div className="button-minus">
                        <img
                            src={images['base_button_plus_and_minus.png']}
                            alt={'base_button_plus_and_minus'}
                    ...
                    <div className="shop-count-item">{count}</div>
                ...
                <div className="shop-total-item">{total}₽</div>
            </div>
        );
    };
    ...
    return (
        <div className="shopping-cart">
            ...
            <div className="shop-card-and-total">
                ...
                <div className="total">
                    <div className="text-total">ИТОГО</div>
                    <div className="total-price">₽ {total}</div>

                    {items.length > 0 ? (
                        <Link to={'/order'}>
                            <button className="place-order">
                                <div className="text-place-order">Перейти к оформлению</div>
                            </button>
                        </Link>
                    ) : (
                        <div>
                            ...
                            {emptyShopOrder && (
                                <div className="empty-shop-order">
