    ...
    return (
      <div className='shop-card'>
        ...
        <div className='button-delete'>
          <img src={images['Button_Delete.png']} width='20px' height='17px' onClick={() => onDelete(id)}/>
        </div>
        <div className='count-items'>
          <div className='button-minus'>
            <img src={images['base_button_plus_and_minus.png']} className='base_button' onClick={() => onDecrease(id)}/>
            <img src={images['minus.png']} className='button-minus-item' onClick={() => onDecrease(id)}/>
          </div>
          <div className='shop-count-item'>
            {count}
          </div>
          <div className='button-plus'>
            <img src={images['base_button_plus_and_minus.png']} className='base_button' onClick={() => onIncrease(id)}/>
            <img src={images['plus.png']} className='button-plus-item' onClick={() => onIncrease(id)}/>
          </div>
        </div>
